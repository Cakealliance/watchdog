.PHONY:test-featuretest-unit test db-reset db-migrate db-rollback db-refresh up build composer-install env-setup generate-app-key cs-fix cs-fix-changed cs-check cs-check-changed phpstan-check phpstan-check-changed composer-check
...
db-refresh: db-reset db-migrate ##db-reset and db-migrate
